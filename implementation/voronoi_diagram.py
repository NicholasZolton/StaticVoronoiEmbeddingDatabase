...
def main():
    ...
    # create a list of the x, y coordinates of the points
    coordinates = [(point[0], point[1]) for point in points]
    coordinates = np.array(coordinates)

    voronoi = Voronoi(coordinates)
    regions, vertices = voronoi_finite_polygons_2d(voronoi, plt=plt, points=coordinates)
    print("Regions: ", regions)
    print("Vertices: ", vertices)

    # pickle the regions and vertices
    # for later use in query_region.py
